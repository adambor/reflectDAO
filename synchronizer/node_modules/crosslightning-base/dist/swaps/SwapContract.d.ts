...
export interface SwapContract<T extends SwapData, TX> {
    ...
    claimWithTxData(swapData: T, blockheight: number, tx: {
        ...
        txid: string;
        hex: string;
    }, vout: number, storedHeader?: BtcStoredHeader<any>, synchronizer?: RelaySynchronizer<any, TX, any>, initAta?: boolean, waitForConfirmation?: boolean, abortSignal?: AbortSignal): Promise<string>;
    ...
    txsClaimWithTxData(swapData: T, blockheight: number, tx: {
        ...
        txid: string;
        hex: string;
    }, vout: number, storedHeader?: BtcStoredHeader<any>, synchronizer?: RelaySynchronizer<any, TX, any>, initAta?: boolean): Promise<TX[]>;
    ...
    createSwapData(type: ChainSwapType, offerer: string, claimer: string, token: TokenAddress, amount: BN, paymentHash: string, expiry: BN, escrowNonce: BN, confirmations: number, payIn: boolean, payOut: boolean): Promise<T>;
